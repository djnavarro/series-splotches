...
#   - adapted from curled_19
#   - smaller and tighter splotches
#   - more curl
...
is_along_grid <- function(x, y, d, seed) {
  ...
  zv <- normalise(zv, min = d/4, max = d/3)
...
if (FALSE) {
  seeds <- c(
    1500, 1502, 1504, 1508, 1511, 1515, 1523, 1536, 1538, 1542,
    1544, 1555, 1563, 1565, 1568, 1569, 1572, 1574, 1579, 1594,
    1599
  )
