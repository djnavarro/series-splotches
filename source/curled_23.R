...
#   - increased upper bound of curl scale
...
create_image_parameters <- function(seed) {
  ...
  list(
    ...
    curl_scale = sample_uniform(min = .00003, max = .0002),
    curl_octaves = 10,
...
if (FALSE) {
  seeds <- c(
    1801, 1804, 1827, 1830, 1832, 1833, 1834, 1835, 1850, 1854,
    1863, 1864, 1869, 1874, 1875, 1877, 1886, 1888, 1894, 1898
  )
